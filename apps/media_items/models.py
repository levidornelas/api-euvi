...
from conf.storages import PublicMediaStorage

s3_storage = PublicMediaStorage()  # instancia única para todos os campos
...
class MediaItem(models.Model):
    ...
    autor_imagem = models.ImageField(
        upload_to="autores/",
        storage=s3_storage,
    ...
    # Galeria
    outra_imagem1 = models.ImageField(
        upload_to="media/outras/",
        storage=s3_storage,
        blank=True, null=True,
        verbose_name='Outra Imagem 1'
    )
    outra_imagem2 = models.ImageField(
        upload_to="media/outras/",
        storage=s3_storage,
        blank=True, null=True,
        verbose_name='Outra Imagem 2'
    )
