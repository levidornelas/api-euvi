...
class MediaItem(models.Model):
    ...
    # Informações do autor (se aplicável)
    autor = models.CharField(max_length=255, null=True, blank=True, verbose_name='Autor')
    autor_imagem = models.URLField(max_length=500, null=True, blank=True, verbose_name='Imagem do Autor')
    ...
    # Imagens do Slider (Com legenda)
    imagem_cartaz = models.URLField(max_length=500, blank=True, null=True, verbose_name='Imagem de Cartaz') 
    legenda_1 = models.CharField(max_length=50, null=True, blank=True, verbose_name='Legenda 1')
    imagem_obra = models.URLField(max_length=500, blank=True, null=True, verbose_name='Imagem da Obra')
    legenda_2 = models.CharField(max_length=50, null=True, blank=True, verbose_name='Legenda 2')
    imagem_local = models.URLField(max_length=500, blank=True, null=True, verbose_name='Imagem Local')
    legenda_3 = models.CharField(max_length=50, null=True, blank=True, verbose_name='Legenda 3')

    # Imagens que irão terminar de compor a galeria.
    outra_imagem1 = models.URLField(max_length=500, blank=True, null=True, verbose_name='Outra Imagem 1')
    outra_imagem2 = models.URLField(max_length=500, blank=True, null=True, verbose_name='Outra Imagem 2')
